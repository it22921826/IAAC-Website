...
function About() {
  ...
  return (
    <>
      {/* --- SECTION 1: INTRO & VIDEO (Original About Content) --- */}
      <motion.section
        id="about"
      ...
      {/* --- SECTION 2: OUR COURSES (Moved from Home) --- */}
      <motion.section
      ...
      {/* --- SECTION 3: MISSION & VISION (Moved from Home) --- */}
      <motion.section
      ...
      {/* --- SECTION 4: FACULTY & OBJECTIVES (Moved from Home) --- */}
      <motion.section
