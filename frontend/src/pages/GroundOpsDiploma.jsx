    ...
    <>
      ...
      <section className="bg-slate-900 pt-32 pb-16 px-6">
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-6">
            ...
            <span>&gt;</span>
            <span className="text-white">Diploma in Airport Ground Operations</span>
          </div>

          <div className="max-w-4xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-6">
              Diploma in <span className="text-blue-500">Airport Ground Operations</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed max-w-2xl">
              Master the complex logistics of aviation. This diploma covers everything from passenger services and weight balance to dangerous goods regulations, preparing you for a dynamic career on the ground.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              <ul className="space-y-3">
                <CurriculumItem text="Travel Information and Planning" />
                <CurriculumItem text="Passenger Services & Customer Services" />
                <CurriculumItem text="Regulatory Bodies and Air Traffic Services" />
                <CurriculumItem text="Introduction to Air Cargo" />
                <CurriculumItem text="Introduction to Weight and Balance" />
                <CurriculumItem text="Aircraft Types and Loading" />
                <CurriculumItem text="Aircraft Operational Messages" />
                <CurriculumItem text="Aviation Weather" />
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
              ...
              {/* Decorative Icon for Ground Ops */}
              <div className="mt-8 flex justify-center opacity-10">
                <Plane size={120} className="text-slate-900" />
              </div>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <InfoCard 
              ...
              subtext="Final Written Exam Included"
            />
      ...
      <section className="py-20 bg-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">Build Your Career on the Ground</h2>
          <p className="text-slate-600 mb-8 text-lg">
            Ground operations are the backbone of the airline industry. Secure your future in aviation management and logistics today.
          </p>
...
export default GroundOpsDiploma;